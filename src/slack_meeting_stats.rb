...
def generate_plots
  ...
  dates.each do |date|
    ...
    attendance_percentages << (total_teams.zero? ? 0 : (present_teams.to_f / total_teams) * 100)
    build_status_percentages << (total_teams.zero? ? 0 : (reporting_builds.to_f / total_teams) * 100)
  end
